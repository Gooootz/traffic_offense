...
<div>
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            // Retrieve the total paid offenses from the current database
			$currentPaidOffensesQuery = $conn->query("SELECT COUNT(*) as total FROM `offense_list1` WHERE status = 1");
			$currentPaidOffenses = $currentPaidOffensesQuery->fetch_assoc()['total'];
            ...
            <div class="row g-4 mb-4">
                <div class="col">
                    <div class="app-card app-card-stat shadow-sm h-100">
                        <div class="app-card-body p-3 p-lg-4">
                            <h4 class="stats-type mb-1">Paid Offenses</h4>
                            <div class="stats-figure">
                                <?php echo number_format($currentPaidOffenses); ?>
                            </div>
                            <div class="stats-meta text-primary">
                                ...
                                </svg> <?php echo $currentPaidOffenses; ?>%
                            </div>
                        </div>
