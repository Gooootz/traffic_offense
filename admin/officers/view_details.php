...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `officers_list` where id = '{$_GET['id']}' ");
...
<div class="container-fluid">
    ...
    <div class="border border-dark px-2 py-2" id="print_out">
            ...
            <tr class='boder-0'>
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex w-max-100">
                                ...
                                <p class="col-md-auto border-bottom border-dark w-100">
                                    <b><?php echo $firstname .' '. $middlename .' '. $lastname.' '. $suffix ?></b>
                                </p>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Officer ID NO:</label>
                                <p class="col-md-auto border-bottom border-dark w-100">
                                    <b><?php echo $officer_id_no ?></b>
                                </p>
                            </div>
                            <div class="row justify-content-between  w-max-100">
                                <div class="col-6 d-flex w-max-100">
                                    ...
                                    <p class="col-md-auto border-bottom px-2 border-dark w-100">
                                        <b><?php echo date("M d, Y",strtotime($dob)) ?></b>
                                    </p>
                                </div>
                                <div class="col-6 d-flex w-max-100">
                ...
                <td width="20%">
                    <div class="w-100 d-flex align-items-center justify-content-center">
                        <img src="<?php echo validate_image($image_path) ?>" alt="Driver's ID" class="img-thumnail"
                            id="cimg" width="150px" height="150px">
                    </div>
                </td>
            </tr>
        </table>
        ...
        <!-- <table class='table table-stripped px-4'>
            ...
            <tbody>
                <?php 
                $olist = $conn->query("SELECT i.*,o.code,o.name FROM `offense_items` i inner join `offenses` o on i.offense_id = o.id where i.driver_offense_id in (SELECT id FROM `offense_list1` where driver_id = '{$driver_id}') order by unix_timestamp(i.date_created) asc  ");
                if($conn->error){
                    echo $conn->error ."\n";
                }
