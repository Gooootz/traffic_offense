...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    $qry2 = $conn->query("SELECT * from `officers_meta` where officer_id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
            ...
            <tr class='boder-0'>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex w-max-100">
                                ...
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $officer_id_no ?></b></p>
                            </div>
                ...
                <td width="20%">
                    <div class="w-100 d-flex align-items-center justify-content-center">
                        <img src="<?php echo validate_image($image_path) ?>" alt="Driver's ID" class="img-thumnail" id="cimg" width="150px" height="150px">
                    </div>
                </td>
            </tr>
        </table>
