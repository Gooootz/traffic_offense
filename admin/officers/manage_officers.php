...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><?php echo isset($id) ? "Update ": "Create a New " ?> Officer</h3>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <br>
                        <input type="text" class="form-control form" required name="officer_id_no"
                            value="<?php echo isset($officer_id_no) ? $officer_id_no : '' ?>"
                            placeholder="(e.g. 01012001)">
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="control-label">Last Name</label>
                        <input type="text" class="form-control form" name="lastname"
                            value="<?php echo isset($lastname) ? $lastname : '' ?>" placeholder="(e.g. Delacruz)"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="firstname" class="control-label">First Name</label>
                        <input type="text" class="form-control form" name="firstname"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form" name="middlename"
                            value="<?php echo isset($middlename) ? $middlename : '' ?>" placeholder="(e.g. Cortes)">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control form" name="dob"
                            value="<?php echo isset($dob) ? date("Y-m-d",strtotime($dob)) : '' ?>">
                    </div>
                    <div class="form-group">
                        <label for="present_address" class="control-label">Present Address</label>
                        <textarea rows="3" class="form-control" style="resize:none" name="present_address"
                            placeholder="(e.g. Solano, Nueva Vizcaya Philippines, 3709)"><?php echo isset($present_address) ? $present_address : '' ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="permanent_address" class="control-label">Permanent Address</label>
                        <textarea rows="3" class="form-control" style="resize:none" name="permanent_address"
                            placeholder="(e.g. Solano, Nueva Vizcaya Philippines, 3709)"><?php echo isset($permanent_address) ? $permanent_address : '' ?></textarea>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select name="civil_status" id="civil_status" class="custom-select select2">
                            <option <?php echo (isset($civil_status) && $civil_status == 'Single') ? 'selected' : '' ?>>
                                Single</option>
                            <option
                                <?php echo (isset($civil_status) && $civil_status == 'In a Relationship') ? 'selected' : '' ?>>
                                In a Relationship</option>
                            <option
                                <?php echo (isset($civil_status) && $civil_status == 'Married') ? 'selected' : '' ?>>
                                Married</option>
                            <option
                                <?php echo (isset($civil_status) && $civil_status == 'Divorced') ? 'selected' : '' ?>>
                                Divorced</option>
                            <option
                                <?php echo (isset($civil_status) && $civil_status == 'Windowed') ? 'selected' : '' ?>>
                                Windowed</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form" required name="nationality"
                            value="<?php echo isset($nationality) ? $nationality : '' ?>" placeholder="(e.g. Filipino)">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="13" class="form-control form" name="contact" inputmode="numeric"
                            value="<?php echo isset($contact) ? $contact : '' ?>" placeholder="(e.g. +639123456789)"
