							...
							<tr>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										...
										<a class="dropdown-item delete_package" href="javascript:void(0)"
								...
								<td>
									<div style="display: inline;" align="center">
										...
										<a class="btn btn-outline-primary"
											href="?page=packages/manage&id=<?php echo $row['id'] ?>">
											<span class="fa fa-edit"></span>
										</a>
										<a class="btn btn-outline-danger delete_package" href="javascript:void(0)"
