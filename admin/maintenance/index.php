							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <a class="dropdown-item delete_package" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-trash text-danger"></span> Delete</a>
				                  </div>
							</td>
							<td>
								<div style="display: inline;" align="center" >
								
									<a class="btn btn-outline-primary" href="?page=packages/manage&id=<?php echo $row['id'] ?>">
										<span class="fa fa-edit"></span>
									</a>
									<a class="btn btn-outline-danger delete_package" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">
